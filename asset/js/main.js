...
$(document).on('click', '#tombolPopup', function (e) {
    ...
    Swal.fire({
        icon: 'info',
        title: 'سلام سایه عزیزم رفیق گلم',
        ...
        Swal.fire({
            ...
            Swal.fire({
                ...
                Swal.fire({
                    ...
                    html: '<br><input class="form-control" placeholder="😍اسم این خوشگله  چیه😍" id="input-field">',
                    content: {
                        element: "input",
                        attributes: {
                    ...
                    function () {
                        ...
                        console.log(nama);
                        Swal.fire({
                            title: '🥺' +nama + ' ' + 'رفیق گلم هنوزم دوشم دالی',
                            icon: 'question',
                            showCancelButton: true,
                            confirmButtonColor: '#3085d6',
                            cancelButtonColor: '#d33',
                            confirmButtonText: 'اره  عشق همیشگی خودمی',
                            cancelButtonText: 'معلومه دوست ندارم',
                            showClass: {
                                popup: 'animate__animated animate__jackInTheBox'
                            },
                            hideClass: {
                            ...
                            if (result.isConfirmed) {
                                Swal.fire({
                                    title: ' 😇 من قربونش برم که انقدر عشق من مهربونه دردش به قلبم فداششم منم دوست دارم عزیزم 😇 ',
                                    showClass: {
                                        popup: 'animate__animated animate__jackInTheBox'
                                    },
                                    hideClass: {
                                    ...
                                    Swal.queue([{
                                        title: 'خب بگو ببینم ' + ' ' + nama + ' ' + ' از صفر تا صد چند تا منو دوست داری🤩',
                                        ...
                                        preConfirm: function (value) {
                                            Swal.insertQueueStep({
                                                title: '🥺 خوشهالم که قلب کوشولوت منو'+ ' ' + value + '%' +'دوست داره ' ,
                                                icon: "info",
                                                showClass: {
                                                    popup: 'animate__animated animate__jackInTheBox'
                                                },
                                            ...
                                            if (result.isConfirmed) {
                                                Swal.fire({
                                                    ...
                                                    Swal.fire({
                                                        title: '😇😇',
                                                        icon: 'info',
                                                        text: 'خب پس کفش های خوشگلتو بپوش تا بریم',
                                                        showClass: {
                                                            popup: 'animate__animated animate__jackInTheBox'
                                                        },
                                                        hideClass: {
                                ...
                                Swal.fire({
                                    title: '😔دلت میاد منو دوست نداشته باشی😔',
                                    icon: 'question',
                                    text: '😔 من به این خوبی    😔',
                                    showCancelButton: true,
                                    confirmButtonText: 'برو بابا بچه پررو',
                                    cancelButtonText: ' معلومه که دوست دارم  ',
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        Swal.fire({
                                            title: ' 😇 من قربونش برم که انقدر سایه من مهربونه دردش به قلبم فداششم منم دوست دارم عزیزم 😇 ',
                                                    ...
                                                    if (result.isConfirmed) {
                                                        Swal.fire({
                                                            ...
                                                            Swal.fire({
                                                                title: '😇😇',
                                                                icon: 'info',
                                                        text: 'خب پس کفش های خوشگلتو که  بپوش تا بریم',
